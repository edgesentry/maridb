...
For implementation-level commands and flags, see [Pipeline Operations](https://github.com/edgesentry/indago/blob/main/.agents/skills/indago-run-pipeline/references/pipeline-operations.md).
...
See [Backtracking Runbook](https://github.com/edgesentry/indago/blob/main/.agents/skills/indago-run-backtrack/references/backtracking-runbook.md) for full CLI reference and demo scenario.
...
See [r2-data-layout.md](ref-r2-data-layout.md) for the full bucket layout, actor responsibilities, and credential model.
