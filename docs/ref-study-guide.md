...
- **Internal Docs:** [docs/pipeline-operations.md](https://github.com/edgesentry/indago/blob/main/.agents/skills/indago-run-pipeline/references/pipeline-operations.md).
...
- **Internal Docs:** [docs/feature-engineering.md](ref-feature-engineering.md).
...
- **Internal Docs:** [docs/scoring-model.md](ref-scoring-model.md) (Graph section).
...
- **Internal Docs:** [docs/scoring-model.md](ref-scoring-model.md) (Algorithms section).
...
- **Internal Docs:** [docs/causal-analysis.md](ref-causal-analysis.md), [docs/backtesting-validation.md](ref-backtesting.md).
...
- **Internal Docs:** [docs/backtesting-validation.md](ref-backtesting.md), [docs/evaluation-metrics.md](ref-evaluation-metrics.md).
...
- **Internal Docs:** [docs/pipeline-catalog.md](ref-pipeline-catalog.md), [docs/pipeline-operations.md](https://github.com/edgesentry/indago/blob/main/.agents/skills/indago-run-pipeline/references/pipeline-operations.md).
