...
The 0.62 baseline was measured on a full Singapore pipeline run with a properly populated AIS dataset. See [evaluation-metrics.md](ref-evaluation-metrics.md) for the full reproduction steps.
