...
from pipelines.score.watchlist import DEFAULT_DB_PATH, build_candidate_watchlist
from pipelines.score.watchlist import DEFAULT_OUTPUT_PATH as DEFAULT_WATCHLIST_PATH
