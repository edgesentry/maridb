...
the C3 causal sanction-response model::
    ...
    from pipelines.score.causal_sanction import run_causal_model, calibrate_graph_weight
...
def compute_composite_scores(
    ...
    if auto_calibrate:
        ...
        try:
            from pipelines.score.causal_sanction import calibrate_graph_weight, run_causal_model
